...
function UserProfileCard() {
  ...
  return (
    ...
    >
      <div>
        <img
          src="https://media-exp1.licdn.com/dms/image/C4D03AQFAKUjQ8zIsFA/profile-displayphoto-shrink_800_800/0/1611671601557?e=1623888000&v=beta&t=Ag0Qlq6NT7nTOfpMSb4m3-HEZQDBGZCyPPXqKTNPHAM"
          className="rounded-lg h-40 w-full mb-4 object-cover"
          alt="profile"
        />
        <h1 className="text-2xl font-medium text-gray-700">Mwelwa Nkuta</h1>
        <p className="text-sm mb-4">
          Aspiring Software Engineer (Express.js/React.js/Javscript)
        </p>
      </div>
      <div className="my-2">
